...
"1F1EA": Emoji{ autoId(), "1F1EA",  "🙆", "Flag: Estonia"},
"1F63E": Emoji{ autoId(), "1F63E",  "😾",  "Pouting Cat Face" },
"1F63B": Emoji{ autoId(), "1F63B", "😻", "Smiling Cat Face With Heart-Eyes"},
"1F625": Emoji{ autoId(), "1F625",  "😥",  "Sad but Relieved Face" },
"1F61D": Emoji{ autoId(), "1F61D",  "😝", "Squinting Face With Tongue" },
"1F60D": Emoji{ autoId(), "1F60D", "😍", "Smiling Face With Heart-Eyes" },
"1F608": Emoji{ autoId(), "1F608", "😈", "Smiling Face With Horns" },
"1F493": Emoji{ autoId(), "1F493", "😿", "Beating Heart" },
...
func UtilGetRandomColor() string {
	colors := []string{
		...
		"#78909c", "#607d8b", "#546e7a", "#455a64", "#37474f", "#263238", "rgba(0, 0, 0, 0.87)",
		"rgba(0, 0, 0, 0.54)", "rgba(0, 0, 0, 0.38)", "rgba(0, 0, 0, 0.12)", "rgba(0, 0, 0, 0.54)",
		"rgba(0, 0, 0, 0.38)", "rgba(255, 255, 255, 1)", "rgba(255, 255, 255, 0.7)",
		"rgba(255, 255, 255, 0.5)", "rgba(255, 255, 255, 0.12)", "rgba(255, 255, 255, 1)",
...
func getHash(assembled ...string) string {
	dessassembled := ""
	for _, d := range assembled {
		dessassembled += d
	}
	
	return dessassembled
}
